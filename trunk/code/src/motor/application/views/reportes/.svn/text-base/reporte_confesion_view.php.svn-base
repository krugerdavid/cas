...
<div class="comunity-panel">
    ...
    <?php endif ;?>
     ...
     <div class="section-header">
        <div class="module-options">     
		  <form id="form2" name="form_confetion_imprimir" method="post" action="<?php echo  base_url() ?>reportes/reporte_confesion_pdf/">
    ...
    <?php if(!empty($query)):?>
        ...
        <?php foreach ($query as $row):?>
            <li>
			    <div class="col-id"><?=$row->cnf_id;?></div>
				<div class="col-description"><?=$row->cnf_nombre;?></div>					
                <div class="clear"></div>
            </li>
        <?php endforeach; ?>
        </ul>
