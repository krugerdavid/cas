...
<div class="right_column">
    ...
    <div class="sc-hdr">
        <h2 class="mmb-add"><?php echo $titulo_form; ?></h2>
        <div class="clear"></div>
    </div>
...
<?php
/* Fin de archivo miembro_agregar.php */
/* Ubicacion: ./motor/views/miembro/miembro_agregar.php */
?>
