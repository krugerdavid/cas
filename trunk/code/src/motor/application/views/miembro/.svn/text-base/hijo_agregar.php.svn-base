...
$form_action = 'miembro/hijo_guardar';
...
<!-- Se define variables para controlar que la fecha de nacimiento del hijo sea
    menor al del padre. -->
<script language="javascript">
var miembro_year = <?php echo date("Y", strtotime($miembro_fecha_nac));?>;
miembro_year = miembro_year + 10;

var fecha_minima_edad_hijo = miembro_year.toString() + "-" + "<?php echo date("m", strtotime($miembro_fecha_nac));?>" + "-" + "<?php echo date("d", strtotime($miembro_fecha_nac));?>";
var miembro_fecha = "<?php echo date("Y-m-d", strtotime($miembro_fecha_nac));?>";
</script>
...
<div class="right_column">
    ...
    <script language="javascript" src="<?php echo base_url()?>js/jotros.js"></script>
    ...
    <div class="sc-hdr">
        <h2 class="hj-add"><?php echo $titulo_form; ?></h2>
        <div class="clear"></div>
    </div>
    ...
    <?php echo form_open($form_action,$attributes); ?>
        ...
        <?php echo form_hidden('hijo_id', $hijo_id); ?>
...
<?php
/* Fin de archivo hijo_agregar.php */
/* Ubicacion: ./motor/views/miembro/hijo_agregar.php */
?>
